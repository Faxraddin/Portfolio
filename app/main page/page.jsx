...
const MainPage = () => {
    return (
      <section>
        ...
        <div className="flex justify-center items-center w-full bg-zinc-100" style={{boxShadow:'0px 2px 4px rgba(0, 0, 0, 0.2)'}}>
          <div className="w-full flex justify-center pt-5">
              
              <div className="flex w-[10%] items-center justify-center flex-col text-left gap-3">
              ...
              <div className="w-[10%] flex items-center justify-center flex-col text-left gap-3">
        ...
        <div className="flex justify-center items-center p-20 h-auto w-full">
          <div className="p-3 w-full flex justify-center items-center flex-col">
            ...
            <div className="pt-5 flex justify-between w-3/4 gap-5">
